...
type LLMClient interface {
	...
	StreamChat(ctx context.Context, chatHistory []ChatMessage, onToken func(string) error) error
}

// MockLLMClient is a mock implementation of the LLMClient interface for testing purposes.
type MockLLMClient struct {
	Error          error
	StreamChatFunc func(ctx context.Context, chatHistory []ChatMessage, onToken func(string) error) error
}
...
func (mock MockLLMClient) StreamChat(ctx context.Context, chatHistory []ChatMessage, onToken func(string) error) error {
	if mock.Error != nil {
		return mock.Error
	}
